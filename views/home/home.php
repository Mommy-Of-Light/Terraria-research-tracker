...
<div class="container">
    ...
    <div id="dashboard" class="hidden">
        ...
        <div class="toolbar compact-toolbar" style="display: flex; gap: 8px; align-items: center; margin-bottom: 8px; flex-wrap: wrap;">
            ...
            <button class="btn" id="resetSearch">Reset Search (no clear)</button>
            <button class="btn" id="restoreAllResearch">Restore All Research</button>
            <button class="btn" id="clearAllResearch">Clear All Research</button>
        </div>
